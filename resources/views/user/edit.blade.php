            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input value="{{ $user->name }}" type="text" id="name" name="name" placeholder="Name..." class="form-control"><small class="form-text text-muted">Input User Name</small></div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="username" class=" form-control-label">Username</label></div>
                            <div class="col-12 col-md-9"><input value="{{ $user->username }}" type="text" id="username" name="username" placeholder="username..." class="form-control"><small class="form-text text-muted">Input User username</small></div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="email" class=" form-control-label">Email</label></div>
                            <div class="col-12 col-md-9"><input value="{{  $user->email }}" type="email" id="email" name="email" placeholder="Email..." class="form-control"><small class="help-block form-text">Please enter user email</small></div>
                        </div>
                        <div class="row form-group">
                                    ...
                                    <div class="form-check">
                                        <div class="radio">
                                            <label for="admin" class="form-check-label ">
                                                <input {{ $user->role == "admin"?'checked':'' }} type="radio" id="admin" name="role" value="admin" class="form-check-input">Admin
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label for="member" class="form-check-label ">
                                                <input {{ $user->role == "member"?'checked':'' }} type="radio" id="member" name="role" value="member" class="form-check-input">Member
                                            </label>
                                        </div>
