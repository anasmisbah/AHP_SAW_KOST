    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card">
                ...
                <form action="{{ route('admin.update',['id'=>Auth::user()->id]) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                <div class="card-body card-block">
                    
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="name" class=" form-control-label">Name</label></div>
                            <div class="col-12 col-md-9"><input value="{{ old('name') ? old('name'):Auth::user()->name}}" type="text" id="name" name="name" placeholder="Name..." class="form-control {{ $errors->first('name')?'is-invalid':'' }}"><small class="form-text text-muted">Input User Name</small>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input value="{{ old('email')?old('email'):Auth::user()->email }}" type="email" id="email" name="email" placeholder="Email..." class="form-control  {{ $errors->first('email')?'is-invalid':'' }}"><small class="help-block form-text">Please enter user email</small>
                                <div class="invalid-feedback">
                                    {{$errors->first('email')}}
                                </div>
                            </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col col-md-9">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input {{ old('role') == 'admin' |Auth::user()->role == 'admin'?'checked':'' }} required type="radio" id="admin" name="role" value="admin" class="custom-control-input">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                        <img src="{{ asset('storage/'.Auth::user()->avatar) }}" class="rounded" alt="" width="200px">
